namespace VokaTester
{
    ...
    using VokaTester.Infrastructure;
    ...
    public class Startup
    {
        ...
        {
            services
                .AddDbContext<VokaTesterDbContext>(options =>
            ...
            IConfigurationSection applicationSettingsConfiguration = this.Configuration.GetSection("ApplicationSettings");
